...
table.insert(ProceduralDistributions["list"]["KitchenDishes"].items,  ItemSpawnChance * 20.20);
...
table.insert(ProceduralDistributions["list"]["SpiffosKitchenCups"].items,  ItemSpawnChance * 20.20);
